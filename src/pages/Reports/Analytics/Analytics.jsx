...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Uchambuzi / Analytics</div>
      <div className="page-header">
        <div><h1>📉 Uchambuzi / Analytics</h1><p>Uchambuzi wa kina wa data ya uhalifu</p></div>
      ...
      <Card><CardHeader title="📉 Uchambuzi / Analytics" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Uchambuzi / Analytics</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Uchambuzi wa kina wa data ya uhalifu</div>
        </div>
      </CardBody></Card>
    </div>
  )
