...
export default function Page() {
  return (
    <div className="afd">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Ripoti'}]} />
      <div className="ph">
        <div><h1>📈 Ripoti / Reports</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        <CardHeader title="📈 Ripoti / Reports" />
        <CardBody>
          ...
          <div style={{textAlign:'center',padding:'40px',color:'var(--text-muted)'}}>
            ...
            <div style={{fontSize:14,fontWeight:600,color:'var(--text-white)',marginBottom:6}}>Ripoti / Reports</div>
