...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Takwimu za Uhalifu</div>
      <div className="page-header">
        <div><h1>📊 Takwimu za Uhalifu</h1><p>Ripoti za uhalifu kwa mkoa na wilaya</p></div>
      ...
      <Card><CardHeader title="📊 Takwimu za Uhalifu" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Takwimu za Uhalifu</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Ripoti za uhalifu kwa mkoa na wilaya</div>
        </div>
      </CardBody></Card>
    </div>
  )
