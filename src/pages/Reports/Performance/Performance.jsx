...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Utendaji / Performance</div>
      <div className="page-header">
        <div><h1>📈 Utendaji / Performance</h1><p>Tathmini ya utendaji wa maafisa na vituo</p></div>
      ...
      <Card><CardHeader title="📈 Utendaji / Performance" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Utendaji / Performance</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Tathmini ya utendaji wa maafisa na vituo</div>
        </div>
      </CardBody></Card>
    </div>
  )
