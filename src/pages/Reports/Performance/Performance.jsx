...
export default function Performance() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Ripoti<span>›</span>Utendaji</div>
      <div className="page-header">
        <div><h1>📈 Utendaji / Performance</h1><p>Tathmini ya utendaji wa maafisa, vituo na mikoa</p></div>
        <div className="flex gap-8"><select className="form-select" style={{width:'auto',fontSize:11,padding:'5px 10px'}}><option>Mei 2024</option></select><Button variant="outline">⬇ Ripoti PDF</Button></div>
      </div>
