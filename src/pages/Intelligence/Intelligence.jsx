...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Ujasusi / Intelligence</div>
      <div className="page-header">
        <div><h1>🧠 Ujasusi / Intelligence</h1><p>Faili za siri – RPC na IGP tu</p></div>
      ...
      <Card><CardHeader title="🧠 Ujasusi / Intelligence" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Ujasusi / Intelligence</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Faili za siri – RPC na IGP tu</div>
        </div>
      </CardBody></Card>
    </div>
  )
