...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Rasilimali Watu / HR</div>
      <div className="page-header">
        <div><h1>👥 Rasilimali Watu / HR</h1><p>Usimamizi wa wafanyakazi</p></div>
      ...
      <Card><CardHeader title="👥 Rasilimali Watu / HR" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Rasilimali Watu / HR</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Usimamizi wa wafanyakazi</div>
        </div>
      </CardBody></Card>
    </div>
  )
