...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Dashibodi ya Kituo</div>
      <div className="page-header">
        <div><h1>🏢 Dashibodi ya Kituo</h1><p>Muhtasari wa kituo – maafisa na kesi za leo</p></div>
      ...
      <Card><CardHeader title="🏢 Dashibodi ya Kituo" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--text-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--text-white)',marginBottom:6}}>Dashibodi ya Kituo</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Muhtasari wa kituo – maafisa na kesi za leo</div>
        </div>
      </CardBody></Card>
    </div>
  )
