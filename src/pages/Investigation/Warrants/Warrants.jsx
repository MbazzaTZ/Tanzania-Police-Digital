...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Amri / Warrants</div>
      ...
      <Card><CardHeader title="⚖️ Amri / Warrants" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Amri / Warrants</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Amri za mahakama zilizotolewa</div>
        </div>
      </CardBody></Card>
    </div>
  )
