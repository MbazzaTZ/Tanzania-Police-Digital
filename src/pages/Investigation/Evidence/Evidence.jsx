...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Ushahidi / Evidence</div>
      ...
      <Card><CardHeader title="🔬 Ushahidi / Evidence" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Ushahidi / Evidence</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Usimamizi wa ushahidi na chain of custody</div>
        </div>
      </CardBody></Card>
    </div>
  )
