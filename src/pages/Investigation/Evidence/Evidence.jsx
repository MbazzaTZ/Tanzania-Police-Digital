...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Uchunguzi'},{label:'Evidence'}]} />
      <div className="page-header">
        <div><h1>🔬 Ushahidi / Evidence</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        <CardHeader title="🔬 Ushahidi / Evidence" />
        <CardBody>
