...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Maafisa / Officers</div>
      <div className="page-header">
        <div><h1>👮 Maafisa / Officers</h1><p>Orodha ya maafisa wote na wasifu wao</p></div>
      ...
      <Card><CardHeader title="👮 Maafisa / Officers" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Maafisa / Officers</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Orodha ya maafisa wote na wasifu wao</div>
        </div>
      </CardBody></Card>
    </div>
  )
