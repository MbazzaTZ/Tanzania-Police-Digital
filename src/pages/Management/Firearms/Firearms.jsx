...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Usimamizi'},{label:'Silaha'}]} />
      <div className="page-header">
        <div><h1>🔫 Silaha / Firearms</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        <CardHeader title="🔫 Silaha / Firearms" />
        <CardBody>
