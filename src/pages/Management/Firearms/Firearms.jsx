...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Silaha / Firearms</div>
      <div className="page-header">
        <div><h1>🔫 Silaha / Firearms</h1><p>Registry ya silaha na leseni</p></div>
      ...
      <Card><CardHeader title="🔫 Silaha / Firearms" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Silaha / Firearms</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Registry ya silaha na leseni</div>
        </div>
      </CardBody></Card>
    </div>
  )
