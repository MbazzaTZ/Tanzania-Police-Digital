...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Mali / Assets</div>
      <div className="page-header">
        <div><h1>🏗️ Mali / Assets</h1><p>Vifaa na mali za polisi</p></div>
      ...
      <Card><CardHeader title="🏗️ Mali / Assets" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Mali / Assets</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Vifaa na mali za polisi</div>
        </div>
      </CardBody></Card>
    </div>
  )
