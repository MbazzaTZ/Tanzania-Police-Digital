...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Usajili wa Magari</div>
      <div className="page-header">
        <div><h1>🚗 Usajili wa Magari</h1><p>Registry ya magari Tanzania</p></div>
      ...
      <Card><CardHeader title="🚗 Usajili wa Magari" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Usajili wa Magari</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Registry ya magari Tanzania</div>
        </div>
      </CardBody></Card>
    </div>
  )
