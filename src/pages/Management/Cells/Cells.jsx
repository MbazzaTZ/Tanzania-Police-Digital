...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Seli / Cells</div>
      <div className="page-header">
        <div><h1>🔐 Seli / Cells</h1><p>Hali ya seli katika vituo</p></div>
      ...
      <Card><CardHeader title="🔐 Seli / Cells" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Seli / Cells</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Hali ya seli katika vituo</div>
        </div>
      </CardBody></Card>
    </div>
  )
