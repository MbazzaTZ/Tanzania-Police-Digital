...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Vituo / Stations</div>
      <div className="page-header">
        <div><h1>🏢 Vituo / Stations</h1><p>Vituo 312 vya Tanzania vya polisi</p></div>
      ...
      <Card><CardHeader title="🏢 Vituo / Stations" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Vituo 312 vya Tanzania vya polisi</div>
        </div>
      </CardBody></Card>
    </div>
  )
