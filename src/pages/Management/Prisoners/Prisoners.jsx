...
export default function Prisoners() {
  return (
    <div className="afd">
      ...
      <div className="ibox mb-sec">⚠️ Wafungwa wanaostahili kuachiwa leo: 0. Mfumo unaangalia muda wa kizuizini moja kwa moja.</div>
      <Card>
        <CardHeader title="🔒 Orodha ya Wafungwa" action={<Button variant="o" size="sm">🔄 Uhamisho</Button>} />
        <CardBody noPadding>
          <div className="tw">
            <table>
              ...
              <tbody>
                {MOCK_PRISONERS.map(p=>(
                  <tr key={p.id}>
                    ...
                    <td className="flex g8"><Button variant="success" size="sm">Achia</Button><Button variant="o" size="sm">🔄 Hamisha</Button></td>
                  </tr>
                ))}
              </tbody>
            </table>
