...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Utekelezaji'},{label:'Ajali'}]} />
      <div className="page-header">
        <div><h1>🚗 Ajali / Accidents</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
