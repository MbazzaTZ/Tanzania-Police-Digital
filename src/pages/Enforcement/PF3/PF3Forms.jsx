...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>PF3 Forms</div>
      <div className="page-header">
        <div><h1>📄 PF3 Forms</h1><p>Fomu za PF3 – kuomba na kusimamia</p></div>
      ...
      <Card><CardHeader title="📄 PF3 Forms" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>PF3 Forms</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Fomu za PF3 – kuomba na kusimamia</div>
        </div>
      </CardBody></Card>
    </div>
  )
