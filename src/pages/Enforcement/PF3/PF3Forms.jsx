...
export default function PF3Forms() {
  ...
  return (
    <div className="afd">
      ...
      <div className="ibox mb-sec">📋 PF3 ni fomu ya lazima kwa kila kukamata, kizuizini au tuhuma nchini Tanzania. Fomu inabidi ijazwe ndani ya masaa 24 baada ya kukamata.</div>
      <Card>
        <CardHeader title="📄 Orodha ya PF3 Forms" action={<Button variant="g">+ PF3 Mpya</Button>} />
        <CardBody noPadding>
          <div className="tw">
            <table>
              ...
              <tbody>
                {forms.map(f=>(
                  <tr key={f.id}>
                    ...
                    <td className="flex g8"><Button variant="o" size="sm">Angalia</Button><Button variant="o" size="sm">🖨️ Chapisha</Button></td>
                  </tr>
                ))}
              </tbody>
            </table>
