...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Matukio / Incidents</div>
      <div className="page-header">
        <div><h1>📝 Matukio / Incidents</h1><p>Ripoti za matukio yaliyotokea</p></div>
      ...
      <Card><CardHeader title="📝 Matukio / Incidents" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Matukio / Incidents</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Ripoti za matukio yaliyotokea</div>
        </div>
      </CardBody></Card>
    </div>
  )
