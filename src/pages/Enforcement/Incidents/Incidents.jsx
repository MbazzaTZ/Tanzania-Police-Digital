...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Utekelezaji'},{label:'Matukio'}]} />
      <div className="page-header">
        <div><h1>📝 Matukio / Incidents</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        <CardHeader title="📝 Matukio / Incidents" />
        <CardBody>
