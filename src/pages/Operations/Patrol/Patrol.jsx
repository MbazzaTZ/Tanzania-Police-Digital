...
export default function Page() {
  return (
    <div className="animate-fade-in">
      ...
      <Card><CardHeader title="🚔 Doria / Patrol" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Doria / Patrol</div>
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>GPS tracking ya maafisa wanaofanya doria</div>
        </div>
      </CardBody></Card>
    </div>
  )
