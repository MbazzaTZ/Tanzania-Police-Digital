...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <div className="breadcrumb"><a href="/">🏠</a><span>›</span>Vizuizi / Roadblocks</div>
      <div className="page-header">
        <div><h1>🚧 Vizuizi / Roadblocks</h1><p>Vizuizi vilivyopo na ripoti zake</p></div>
      ...
      <Card><CardHeader title="🚧 Vizuizi / Roadblocks" /><CardBody>
        ...
        <div style={{textAlign:'center',padding:40,color:'var(--clr-muted)'}}>
          ...
          <div style={{fontSize:12,maxWidth:400,margin:'0 auto'}}>Vizuizi vilivyopo na ripoti zake</div>
        </div>
      </CardBody></Card>
    </div>
  )
