...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Mfumo'},{label:'Mipangilio'}]} />
      <div className="page-header">
        <div><h1>⚙️ Mipangilio</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        ...
        <CardBody>
          ...
          <div style={{textAlign:'center',padding:'40px',color:'var(--clr-muted)'}}>
            ...
            <div style={{fontSize:14,fontWeight:600,color:'var(--clr-white)',marginBottom:6}}>Mipangilio</div>
