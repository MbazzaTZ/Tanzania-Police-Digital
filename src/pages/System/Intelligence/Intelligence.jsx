...
export default function Page() {
  return (
    <div className="animate-fade-in">
      <Breadcrumb items={[{label:'🏠',href:'/'},{label:'Mfumo'},{label:'Intelligence'}]} />
      <div className="page-header">
        <div><h1>🧠 Ujasusi / Intelligence</h1><p>Module hii itaunganishwa na Supabase backend katika Sprint 2</p></div>
      ...
      <Card>
        <CardHeader title="🧠 Ujasusi / Intelligence" />
        <CardBody>
          ...
          <div style={{textAlign:'center',padding:'40px',color:'var(--text-muted)'}}>
            ...
            <div style={{fontSize:14,fontWeight:600,color:'var(--text-white)',marginBottom:6}}>Ujasusi / Intelligence</div>
